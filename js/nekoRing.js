...
<div class="webring-wrapper">
  ...
  <img src="https://darkosparko.nekoweb.org/webrings/neko-tag/neko-tag-images/nekotag-ears.png">
  </div>

  <div class="webring-flex">
    <div class="webring-prev">
      <a href="${sites[previousIndex]}" target="_parent">
        <img class="arrow-image" src="https://darkosparko.nekoweb.org/webrings/neko-tag/neko-tag-images/arrow-0970.png" style="transform: scaleX(-1);">
      </a>
    </div>
    <div class="box">
    ...
    <div class="webring-next">
      <a href="${sites[nextIndex]}" target="_parent">
        <img class="arrow-image" src="https://darkosparko.nekoweb.org/webrings/neko-tag/neko-tag-images/arrow-0970.png">
      </a>
    </div>
  </div>
  
  <div class="hfwr">
  <div class="webring-subtitle">You are currently at coordinates <span style="font-weight: bold;">${coordinates[thisIndex]}</span> on the map!</div>
  <div class="webring-footer">
    <span class='webring-links'>
      ${randomText}
      ${indexText}
      <a href='https://garlic.garden/onionring/' target="_parent">What Is This?</a></span></td>
    </span>
  </div>
  </div>
</div>
